//import { commonUrl } from '../utils/commonUrl';
...
describe('Two-Factor Authentication', () => {
    ...
    // cy.commonUrl();
      cy.get("input[name=email]").should('have.attr', 'type', 'text').type("emily.grimes@allygroup.com.au");cy.wait(4000);
      cy.get("input[name=password]").should('have.attr', 'type', 'password').type("Emily2003*");cy.wait(4000);
      cy.get('.login-btn__CyH4A').should('have.attr', 'type', 'submit').click();cy.wait(4000);
